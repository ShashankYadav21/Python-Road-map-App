...
const FOUNDATION_PROJECTS = [
  {
    ...
    tags: ["CLI", "OOP", "Architecture", "Systems"],
    desc: "Build terminal-based productivity systems that develop modular programming and engineering discipline.",
    instructions: ["Notes manager with tags & search","Expense tracker with categories & monthly reports","Password manager with AES encryption","Pomodoro timer with session history & analytics","JSON/SQLite storage backend","Modular folder structure — one file per feature","Full OOP architecture throughout","Robust error handling & input validation","Export/import support (CSV + JSON)"],
  ...
  },
  {
    ...
    desc: "Interactive visualizers for algorithms and computational thinking systems.",
    instructions: ["Bubble sort animation with swap highlighting","Merge sort divide-and-conquer visualization","Quick sort partition visualization","Heap sort tree view","BFS layer-by-layer traversal on a grid","DFS backtracking visualization","A* pathfinding with heuristic display","Graph traversal with adjacency list view","Recursion tree unfolding animation","Speed controls + step-by-step mode"],
    stack: ["Python", "Tkinter", "React (optional)"],
  },
  {
    id: "fp3", title: "Mini Linux Shell", emoji: "🐚",
    difficulty: "Engineer", time: "2–3 Weeks",
    glow: "#22D3EE", glowRgb: "34,211,238",
    tags: ["OS", "Shell", "Processes"],
    desc: "Build a custom shell environment to understand operating systems and process execution.",
    instructions: ["Custom command parsing & execution engine","Alias system with persistence","Full command history with up/down navigation","Piping between commands (cmd1 | cmd2)","Subprocess spawning & signal handling","Built-in commands: cd, ls, echo, cat, grep","Environment variable support","Background process execution with &","Error redirection and stderr handling"],
    stack: ["Python"],
  },
  {
    id: "fp4", title: "Mini Git Engine", emoji: "🔀",
    difficulty: "Engineer", time: "2–3 Weeks",
    glow: "#F87171", glowRgb: "248,113,113",
    tags: ["Git", "Internals", "Architecture"],
    desc: "Rebuild Git internals from scratch to understand version control systems deeply.",
    instructions: ["init, add, commit command implementations","Branch creation, switching & deletion","Full commit log with graph visualization","File diff engine (line-level changes)","File snapshots via SHA-1 content hashing","Staging area (index) simulation","Object store: blobs, trees, commit objects","Merge logic (fast-forward & 3-way)",".ignore file parsing & exclusion"],
    stack: ["Python"],
  },
  {
    id: "fp5", title: "Developer Portfolio OS", emoji: "🖥️",
    difficulty: "Advanced", time: "2 Weeks",
    glow: "#38BDF8", glowRgb: "56,189,248",
    tags: ["Frontend", "Branding", "UI Engineering"],
    desc: "Build a futuristic operating-system-style developer portfolio with a powerful visual identity.",
    instructions: ["Terminal-style UI with boot sequence animation","AI assistant (Claude API) answering questions about you","Live GitHub stats via GitHub API","Command palette (Cmd+K) for navigation","Framer Motion page transitions & hover states","Responsive design for all screen sizes","Dark mode with neon accent system","Project showcase with live demo links","Blog section with MDX support"],
    stack: ["Next.js", "Tailwind", "Framer Motion", "Claude API"],
  },
  {
    id: "fp6", title: "Elite SaaS Application", emoji: "💼",
    difficulty: "Advanced", time: "3–4 Weeks",
    glow: "#22C55E", glowRgb: "34,197,94",
    tags: ["SaaS", "Full Stack", "Product Engineering"],
    desc: "Production-grade SaaS application focused on scalable architecture and real product engineering.",
    instructions: ["JWT auth with refresh token rotation","Multi-panel user dashboard with analytics","Stripe payments: subscriptions + one-time","Usage analytics with Recharts visualization","Email notifications (SendGrid/Resend)","GitHub Actions CI/CD pipeline","Docker + cloud deployment (Railway/AWS)","Role-based access: free vs pro vs admin","Customer billing portal"],
    stack: ["Next.js", "FastAPI", "PostgreSQL", "Stripe", "Redis"],
  },
  {
    id: "fp7", title: "Real-Time Chat Platform", emoji: "💬",
    difficulty: "Advanced", time: "3 Weeks",
    glow: "#818CF8", glowRgb: "129,140,248",
    tags: ["Realtime", "Concurrency", "Scale"],
    desc: "Discord-style scalable real-time communication platform built for concurrency.",
    instructions: ["WebSocket connection management at scale","Online presence system with status indicators","Typing indicators with debounce","File & image upload with S3/Cloudflare R2","Message reactions with emoji picker","Redis pub/sub for horizontal scaling","Message history with infinite scroll","Channels, DMs & thread replies","Read receipts & notification system"],
...
const ELITE_PROJECTS = [
  {
    id: "ep1", title: "Scalable URL Shortener", emoji: "🔗",
    difficulty: "Advanced Systems", time: "2 Weeks",
    glow: "#F472B6", glowRgb: "244,114,182",
    tags: ["Backend", "Scaling", "APIs"],
    desc: "Build a production-grade Bitly-inspired backend platform with real caching and analytics.",
    instructions: ["Base62 encoding for short URL generation","Redis caching layer for sub-millisecond redirects","Click analytics: geo, device, referrer tracking","Rate limiting per IP + API key","QR code generation endpoint","Custom alias support with collision detection","Expiring links with TTL","Dashboard API for analytics aggregation","Health check & metrics endpoints"],
    stack: ["FastAPI", "Redis", "PostgreSQL", "Python"],
  },
  {
    id: "ep2", title: "Distributed File Storage", emoji: "☁️",
    difficulty: "System Architect", time: "3 Weeks",
    glow: "#60A5FA", glowRgb: "96,165,250",
    tags: ["Distributed Systems", "Infra", "Storage"],
    desc: "Mini distributed cloud storage engine inspired by Google Drive architecture.",
    instructions: ["Chunked multipart file upload with resume support","AES-256 encryption before storage","Replication across multiple storage nodes","Optimized parallel chunk download assembly","REST API with presigned time-limited URLs","File deduplication via SHA-256 content hashing","Node health monitoring & automatic failover","Admin dashboard with storage node analytics","Docker compose multi-node setup"],
    stack: ["FastAPI", "Docker", "PostgreSQL", "Redis", "React"],
  },
  {
    id: "ep3", title: "Microservices Platform", emoji: "⚙️",
    difficulty: "System Architect", time: "3 Weeks",
    glow: "#FB923C", glowRgb: "251,146,60",
    tags: ["Microservices", "APIs", "DevOps"],
    desc: "Real-world microservices backend ecosystem with independent deployable services.",
    instructions: ["Auth service: JWT + OAuth2 + refresh tokens","Payment service: Stripe webhook processing","Notification service: email + push + SMS","API Gateway: routing, auth, rate limiting","Inter-service communication via REST + events","Docker containers per service","Message queue: async event propagation","Service discovery & health checks","Centralized logging with correlation IDs"],
    stack: ["FastAPI", "Node.js", "Docker", "Redis", "Kafka"],
  },
  {
    id: "ep4", title: "Mini Database Engine", emoji: "🗄️",
    difficulty: "Advanced Systems", time: "3 Weeks",
    glow: "#2DD4BF", glowRgb: "45,212,191",
    tags: ["Databases", "Internals", "Systems"],
    desc: "Build a simple database engine from scratch to understand storage and query internals.",
    instructions: ["Binary page-based persistence to disk","B-tree index implementation","SQL-like query parser (SELECT, INSERT, UPDATE)","Query execution engine with WHERE filters","Table schema definition & validation","Write-ahead log (WAL) for crash recovery","Buffer pool manager for page caching","Simple transaction: begin/commit/rollback","REPL for interactive querying"],
    stack: ["Python"],
  },
  {
    id: "ep5", title: "JARVIS AI Assistant", emoji: "🤖",
    difficulty: "System Architect", time: "1–2 Months",
    glow: "#FBBF24", glowRgb: "251,191,36",
    tags: ["AI", "Agents", "Automation"],
    desc: "A full AI operating assistant with memory, automation, voice, and multimodal intelligence.",
    instructions: ["Wake-word voice interface (Whisper STT + ElevenLabs TTS)","Long-term episodic memory via vector DB (ChromaDB)","Browser automation with Playwright + AI navigation","Desktop automation: open apps, manage files, run scripts","Multi-agent reasoning system with specialist sub-agents","Local LLM fallback with Ollama (Llama 3/Mistral)","RAG pipeline over personal notes, docs & emails","Plugin architecture — add capabilities as Python modules","React dashboard: active tools, memory browser, tool logs"],
    stack: ["Python", "FastAPI", "Whisper", "ChromaDB", "Ollama", "Playwright"],
  },
  {
    id: "ep6", title: "AI Coding Assistant", emoji: "🧑‍💻",
    difficulty: "AI Engineer", time: "3 Weeks",
    glow: "#C084FC", glowRgb: "192,132,252",
    tags: ["AI", "Developer Tools", "LLMs"],
    desc: "Context-aware coding assistant that understands entire repositories and reasons over code.",
    instructions: ["Ingest entire GitHub repos into vector store","Natural language chat over full codebase","Semantic code search with embedding similarity","Inline explanation & auto-documentation generation","Bug detection with fix suggestions & diff view","Multi-file context window management","Git blame integration — explain why code changed","VS Code extension via Language Server Protocol (bonus)","Streaming responses with token-by-token display"],
    stack: ["Python", "LangChain", "ChromaDB", "Claude API", "FastAPI"],
  },
  {
    id: "ep7", title: "AI DevOps Monitor", emoji: "📡",
    difficulty: "AI Systems", time: "2–3 Weeks",
    glow: "#F87171", glowRgb: "248,113,113",
    tags: ["DevOps", "Monitoring", "AI"],
    desc: "AI-powered infrastructure monitoring and intelligent crash analysis system.",
    instructions: ["Real-time log ingestion pipeline","LLM-powered crash explanation (plain English RCA)","Anomaly detection on metrics time-series","Grafana-style monitoring dashboard","Smart alert system: suppress noise, escalate real issues","Incident timeline reconstruction from logs","Auto-generated runbook suggestions","Slack/email alert integration","Historical incident search via RAG"],
    stack: ["Python", "FastAPI", "Prometheus", "Grafana", "Claude API"],
  },
  {
    id: "ep8", title: "Operating System Component", emoji: "🔧",
    difficulty: "Insane", time: "1 Month",
    glow: "#94A3B8", glowRgb: "148,163,184",
    tags: ["OS", "Kernel", "Low-Level"],
    desc: "Low-level operating system subsystem engineering — the deepest project on this list.",
    instructions: ["Round-robin + priority process scheduler","Virtual memory manager with page tables","Page fault handler & demand paging","Simple filesystem: inodes, directories, files","Syscall interface (open, read, write, fork, exec)","Interrupt handling simulation","Memory allocator: malloc/free from scratch","Kernel-user space separation concept","Boot sequence & init process"],
    stack: ["C", "C++", "x86 Assembly (optional)"],
  },
  {
    id: "ep9", title: "Programming Language", emoji: "⚡",
    difficulty: "Insane", time: "1 Month",
    glow: "#F472B6", glowRgb: "244,114,182",
    tags: ["Compilers", "Parsing", "Language Design"],
    desc: "Create a fully interpreted programming language from scratch — the final boss of software engineering.",
    instructions: ["Lexer: tokenize raw source → token stream","Recursive descent parser: tokens → AST","AST node types for all constructs","Tree-walk interpreter for AST execution","Variables, closures & lexical scoping","First-class functions & higher-order functions","Control flow: if/else, while, for, break","Standard library: print, len, type, math, strings","Error reporting with line numbers & context","REPL with history & multiline support"],
    stack: ["Python", "Rust (advanced variant)"],
  },
  {
    id: "ep10", title: "Scalable Social Media Backend", emoji: "🌐",
    difficulty: "System Architect", time: "3–4 Weeks",
    glow: "#E879F9", glowRgb: "232,121,249",
    tags: ["Distributed Systems", "Backend", "Scaling"],
    desc: "Twitter/X-style scalable distributed backend — the complete engineering architecture challenge.",
    instructions: ["Feed generation: push vs pull fanout strategies","Celebrity fanout problem solution (hybrid model)","Kafka event streaming for async feed updates","Redis sorted sets for timeline caching","Trending topics with sliding window counters","Sharded user ID system for horizontal scaling","GraphQL API for flexible client queries","CDN integration for media delivery","Full system design doc with trade-offs"],
    stack: ["FastAPI", "Redis", "PostgreSQL", "Kafka", "GraphQL"],
  },
  {
    id: "ep11", title: "Open Source Contributions", emoji: "🌍",
    difficulty: "Engineer", time: "Ongoing",
    glow: "#22C55E", glowRgb: "34,197,94",
    tags: ["Open Source", "Collaboration"],
    desc: "Real engineering contributions to production-grade public projects used by thousands.",
    instructions: ["Find a project you use (FastAPI, LangChain, Next.js, etc.)","Read the CONTRIBUTING.md — understand the process","Find a real bug: reproduce it locally, write a failing test","Submit the fix with the test — clean PR, good description","Pick up a 'good first issue' from a larger repo","Improve documentation with working code examples","Review other contributors' PRs — leave useful feedback","Build reputation: consistent contributions over months","Target: 1 merged PR per month minimum"],
    stack: ["Python", "TypeScript", "Rust", "Go (depending on project)"],
  },
];
